...
from PaginaDeletarUsuario import PaginaDeletarUsuario
from PaginaAlterarUsuario import PaginaAlterarUsuario
from PaginaAlterarPermissoes import PaginaAlterarPermissoes
