...
CREATE TABLE `entradaestoque` (
  ...
  PRIMARY KEY (`identradaestoque`,`produto_idproduto`),
  KEY `fk_entradaestoque_produto1_idx` (`produto_idproduto`),
  CONSTRAINT `fk_entradaestoque_produto1` FOREIGN KEY (`produto_idproduto`) REFERENCES `produto` (`idproduto`)
...
-- Dump completed on 2025-01-17 23:03:26
